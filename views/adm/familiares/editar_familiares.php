...
$dados=$familiares->SelecaoEspeci($id);
...
if(isset($_POST['atualizar'])){ 
    ...
    $sql=$pdo->prepare("SELECT* FROM paciente where id=$id_paciente ");
                ...
                foreach ($dds as $key => $value) {
                    ...
                    $nome_paciente= $value['nome'];

                    }
}
                
                if(($familiares->AtualizarDados($id,$nome,$id_paciente,$nome_paciente,$telefone,$ficha,$morada)==true)){
                        ...
                        <div class="card">
                            <div class="card-body profile-card">
                                <center class="mt-4"> <img src="../../../assets/images/users/normal.png ?>"
                                    ...
                                    <h6 class="card-subtitle">Familiar</h6>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="nome" type="text" placeholder="<?php
                                     foreach ($dados as $key => $value) {
                                    ...
                                    <div class="form-group">
                                        <div class="col-sm-12 d-flex">
                                            <button type="submit" name="atualizar" class="btn btn-success mx-auto mx-md-0 text-white">Atualizar</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
