...
$sql=$pdo->prepare("SELECT COUNT(nome) count FROM familiar");
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Familiares</h3>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex">
                                    <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Familiares </h4>
                                    
                                    <a href="cadastro_familiares.php"><button class="btn " style="background-color:#2d2e30;color:#fff;" 
                                  ><i class="far fas fa-users"></i> Add Familiar</button></a> 
                                ...
                                <div class="table-responsive mt-5">
                                    <table class="table stylish-table no-wrap" style="height:200px;">
                                        <thead>
                                            <tr>
                                                <th class="border-top-0" colspan="2">Perfil</th>
...
$result=$familiares->BuscaTotal($pesquisar,$limite,$inicio);

foreach ($result as $key => $value) {

    $id_pac= $value['id_paciente'];
...
<td class="align-middle">
    <h6>Familiar</h6><small class="text-muted">';

    $sql=$pdo->prepare("SELECT* FROM paciente where id =$id_pac ");
...
<td class="align-middle">'.$value['morada'].'</td>
<td class="align-middle">'.$value['telefone'].'</td>
<td class="align-middle"><a href="editar_familiares.php?id='.$value['id'].';"><i class="far fa-edit"></i></a></td>
<td class="align-middle"><a href="excluir_familiares.php?id='.$value['id'].';"><i class="far fa-trash-alt"></i></a></td>
</tr>
...
';
    ...
    $sql=$pdo->prepare("SELECT* FROM familiar ORDER BY nome limit $inicio,$limite ");
...
<td style="width:50px;"><span class="round"> </span></td>
<td class="align-middle">
    <h6>Familiar de:</h6><small class="text-muted">';
