...
$sql=$pdo->prepare("SELECT COUNT(nome) count FROM paciente");
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Pacientes</h3>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex">
                                    <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Paciente </h4>

                                    
                                    
                                    <a style="margin-right:0px;" href="cadastro_paciente.php"><button class="btn " style="background-color:#2d2e30;color:#fff;width:150px;" 
                                  ><i class="far fas fa-procedures"></i> Add Paciente</button></a> 
...
$result=$paciente->BuscaTotal2($pesquisar,$limite,$inicio);
...
<td class="align-middle">
    <h6>Paciente</h6><small class="text-muted">'.$value['provincia'].'</small>
</td>
...
<td class="align-middle"><a href="../pdf.php?id='.$value['id'].';"><i class="fas fa-file-pdf"></i></a></td>
<td class="align-middle"><a href="editar_paciente.php?id='.$value['id'].';"><i class="far fa-edit"></i></a></td>
<td class="align-middle"><a href="excluir_paciente.php?id='.$value['id'].';"><i class="far fa-trash-alt"></i></a></td>
</tr>
...
';
    ...
    $sql=$pdo->prepare("SELECT* FROM paciente ORDER BY nome limit $inicio,$limite ");
