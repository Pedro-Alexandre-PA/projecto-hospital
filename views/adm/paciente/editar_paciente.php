...
$dados=$paciente->SelecaoEspeci($id);
...
if(isset($_POST['atualizar'])){ 
    ...
    if(isset($_POST['id_doctor']) && $_POST['id_doctor']!=""){
        ...
        if(($paciente->AtualizarDados($id,$nome,$idade,$sexo,$peso,$altura,$data_nasc,$telefone,$bi,$provincia,$municipio
                            ...
                            <div class="card-body">
                                <form method="post" class="form-horizontal form-material mx-2">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" name="nome" placeholder="<?php


                                            $result= $paciente->selecaoEspeci($id);
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="idade" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="peso" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="altura" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="data_nasc" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="telefone" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="bi" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="provincia" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="municipio" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="bairro" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="rua" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="causa_adm" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="alergia" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="doencas_assoc" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="data_adm" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="data_int" type="text" placeholder="<?php
...
?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="sala" type="text" placeholder="<?php
