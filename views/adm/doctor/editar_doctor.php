...
$dados=$doctor->SelecaoEspeci($globalid);

if(isset($_POST['atualizar'])){ 
 
    $nome=$_POST['nome'];
    $especialidade=$_POST['especi'];
    $email=$_POST['email'];
    ...
    $foto=$_POST['foto'];
                ...
                if(($doctor->AtualizarDados($globalid,$nome,$especialidade,$email,$morada,$telefone,$foto)==true)){
                    ...
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="doctor.php">Familiares</a></li>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                        <label class="col-md-12 mb-0">Especialidade</label>
                                        <div class="col-md-12">
                                            <input name="especi" type="text" placeholder="<?php 
                                    foreach ($dados as $key => $value) {


                                    echo $value['especialidade'];
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="morada" type="text" placeholder="<?php 
                                    foreach ($dados as $key => $value) {
