...
$sql=$pdo->prepare("SELECT COUNT(nome) count FROM doctor");
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="doctor.php" aria-expanded="false">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex">
                                    <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Doctor </h4>
                                    
                                    <a href="cadastro_doctor.php"><button class="btn " style="background-color:#2d2e30;color:#fff;" 
                                  ><i class="far fas fa-user-md"></i> Add Doctor</button></a> 
...
$result=$doctor->BuscaTotal($pesquisar,$limite,$inicio);
...
<td style="width:50px;"><span class="round"><img src="../../../assets/images/users/'.$value['foto'].'"
            alt="user" width="50"></span></td>
<td class="align-middle">
    <h6>Doctor</h6><small class="text-muted">'.$value['especialidade'].'</small>
</td>
<td class="align-middle">'.$value['nome'].'</td>
<td class="align-middle">'.$value['morada'].'</td>
<td class="align-middle">'.$value['telefone'].'</td>
<td class="align-middle"><a href="editar_doctor.php?id='.$value['id'].';"><i class="far fa-edit"></i></a></td>
<td class="align-middle"><a href="excluir_doctor.php?id='.$value['id'].';"><i class="far fa-trash-alt"></i></a></td>
</tr>
...
';
    ...
    $sql=$pdo->prepare("SELECT* FROM doctor ORDER BY nome limit $inicio,$limite ");
