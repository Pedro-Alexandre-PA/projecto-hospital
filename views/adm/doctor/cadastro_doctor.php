...
if(isset($_POST['cadastrar2'])){ 
    ...
    $novo_nome="1.jpg";
                ...
                if(($usuario->Cadastrar($nome,$especialidade,$email,$morada,$telefone,$novo_nome)==true)){
                    ...
                    <div class="col-md-6 col-8 align-self-center">
                        ...
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="usuarios.php">Doctor</a></li>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="especi" type="text" placeholder="Exemplo: Cirugião"
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input name="email" type="email" placeholder="Exemplo: João@gmail.com"
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
