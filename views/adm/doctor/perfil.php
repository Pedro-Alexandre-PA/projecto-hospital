            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body profile-card">
                                <center class="mt-4"> <img src="../../assets/images/users/<?php echo $_SESSION["foto_user"]; ?>"
                                        class="rounded-circle" width="150" />
                                    <h4 class="card-title mt-2"><?php echo $_SESSION["nome_user"]; ?></h4>
                                    <h6 class="card-subtitle"><?php echo $_SESSION["chave_user"]; ?></h6>
                    ...
                    <div class="col-lg-8 col-xlg-9 col-md-7">
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" action="usuario/editar_user.php">
