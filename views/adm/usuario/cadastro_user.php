...
if(isset($_POST['cadastrar2'])){ 
    ...
    $senha=$_POST['senha'];
    $chave=$_POST['chave'];
    $novo_nome="normal.jpg";


                
                if(($usuario->Cadastrar($nome,$senha,$chave,$novo_nome)==true)){
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" method="post">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-12">Tipo de usuário</label>
                                        <div class="col-sm-12 border-bottom">
                                            <select name="chave" class="form-select shadow-none border-0 ps-0 form-control-line">
                                    ...
                                    <div class="form-group">
                                        <label class="col-md-12 mb-0">Confirmar Senha</label>
                                        <div class="col-md-12">
                                            <input name="senha2" type="password" placeholder="********"
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
