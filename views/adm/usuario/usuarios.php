...
$sql=$pdo->prepare("SELECT COUNT(nome) count FROM usuarios");
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0">Usuários</h3>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex">
                                    <h4 class="card-title col-md-10 mb-md-0 mb-3 align-self-center">Usuários </h4>
                                    
                                    <a href="cadastro_user.php"><button class="btn " style="background-color:#2d2e30;color:#fff;" 
                                  ><i class="far fa-user-circle"></i> Add usuário</button></a> 
...
$result=$user->BuscaTotal($pesquisar,$limite,$inicio);
...
<td class="align-middle">
    <h6>Usuário</h6><small class="text-muted">'.$value['chave'].'</small>
</td>
<td class="align-middle">'.$value['nome'].'</td>
<td class="align-middle"><a href="editar_user.php?id='.$value['id'].';"><i class="far fa-edit"></i></a></td>
<td class="align-middle"><a href="excluir_user.php?id='.$value['id'].';"><i class="far fa-trash-alt"></i></a></td>
</tr>
...
';
    ...
    $sql=$pdo->prepare("SELECT* FROM usuarios ORDER BY nome limit $inicio,$limite ");
