...
if (isset($_SESSION["id_adm"])) {
    ...
    $sql->execute(array($_SESSION["id_adm"]));
...
<body>
    ...
    <div id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
        ...
        <!-- Page wrapper  -->
        <!-- ============================================================== -->
        <div class="page-wrapper" style="background-image: url('../../assets/img/img3.jpg');
   background-size: 1000px 600px; opacity: 1 ;" >
   ...
   <div    style=" height:586px;" >
            ...
            <div class="container-fluid" >
                ...
                <div class="row" >
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-end">
                                    <h2 class="font-light mb-0"><i class="fas fa-procedures"></i> <?php
                                    ...
                                    echo $r; ?></h2>
                                    <span class="text-muted">Número de pacientes</span>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Familíares</h4>
                                <div class="text-end">
                                    <h2 class="font-light mb-0"><i class="fas fa-users"></i> <?php
                                    $sql=$pdo->prepare("SELECT* FROM familiar ");
                                    ...
                                    echo $r; ?></h2>
                                    <span class="text-muted">Número de familíares</span>
                                </div>
                    ...
                    <div class="col-sm-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-end">
                                    <h2 class="font-light mb-0"><i class=" fas fa-user-md"></i> <?php
                                    ...
                                    echo $r; ?></h2>
                                    <span class="text-muted">Número de doutores</span>
                                </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="text-end">
                                    ...
                                    echo $r; ?></h2>
                                    <span class="text-muted">Número de usuários</span>
                                </div>
    ...
    <?php
        ...
        echo '<script src="../../resources/js2/custom3.js"></script>';
