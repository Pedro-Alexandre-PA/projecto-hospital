...
if(isset($_POST['cadastrar2'])){ 
    ...
    $datain= date("Y-m-d");
                ...
                if(($relatorio->Cadastrar($value['id'],$value['nome'],
                $value['antecedentes'],$value['data_inter'],$value['nome_doctor'],$value['idade'],$value['provincia'],$value['municipio'],
                $value['bairro'],$value['rua'],$texto,$datain)==true)){
