                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body profile-card">
                                <center class="mt-4"> <img src="../../assets/images/users/<?php echo $_SESSION["foto_adm"]; ?>"
                                        class="rounded-circle" width="150" />
                                    <h4 class="card-title mt-2"><?php echo $_SESSION["nome_adm"]; ?></h4>
                                    <h6 class="card-subtitle"><?php echo $_SESSION["chave_adm"]; ?></h6>
                            ...
                            <div class="card-body">
                                <form class="form-horizontal form-material mx-2" action="editar_perfil.php">
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <input type="text" disabled  placeholder="<?php echo $_SESSION["nome_adm"]; ?>"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                        <input disabled name="foto" type="file" 
                                                class="form-control ps-0 form-control-line">
                                        </div>
                                    </div>
