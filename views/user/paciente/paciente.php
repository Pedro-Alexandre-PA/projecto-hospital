                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="../../../assets/images/users/<?php echo $_SESSION["foto_user"]; ?>" alt="user" class="profile-pic me-2"><?php echo $_SESSION["nome_user"]; ?>
                            </a>
...
$x= $_SESSION["id_paciente"];

$sql=$pdo->prepare("SELECT* FROM paciente where id=$x ");
