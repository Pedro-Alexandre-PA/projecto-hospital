...
if (isset($_SESSION["id_user"])) {
    ...
    $sql = $pdo->prepare("SELECT* from familiar WHERE id= ?");
    ...
    if ($sql->rowCount()==1) {
        ...
        $_SESSION['senha_user']=$dado['ficha'];
                    ...
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link"
                                href="index.php" aria-expanded="false"><i class="me-3 far fa-clock fa-fw"
                                    aria-hidden="true"></i><span class="hide-menu">Hospital Dashboard</span></a></li>
            ...
            <div class="page-breadcrumb">
                <div class="row align-items-center">
                    <div class="col-md-6 col-8 align-self-center">
                        <h3 class="page-title mb-0 p-0"><?php echo $_SESSION["nome_user"]; ?></h3>
