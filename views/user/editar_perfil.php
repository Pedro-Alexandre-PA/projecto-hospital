...
if(isset($_POST['atualizar'])){ 
    ...
    if (isset($_FILES['foto'])) {
        ...
        $diretorio= "../../assets/images/users/";
   
        move_uploaded_file($_FILES['foto']['tmp_name'], $diretorio.$novo_nome);
       
        // fim file

        if(($user->AtualizarDados($id,$nome,$senha,$chave,$novo_nome)==true)){
    ...
    }else if((isset($_POST['senha']) && isset($_POST['senha2'])) ){  
        
        if($_POST['senha']==$_POST['senha2']){ 
    $nome=$_POST['nome'];
    $senha=$_POST['senha'];
    $chave=$_POST['chave'];
    $novo_nome=$_POST['foto'];
                ...
                if(($user->AtualizarDados($id,$nome,$senha,$chave,$novo_nome)==true)){
                    ...
                    Erro ao cadastrar
                        ...
                        echo '<br>
                        <div class="alert alert-danger" style="text-align:center;" role="alert">
                        Por favor, verifique se as senhas.
                        </div>';
                    ...
                    <div class="col-lg-4 col-xlg-3 col-md-5">
                        <div class="card">
                            <div class="card-body profile-card">
                                <center class="mt-4"> <img src="../../assets/images/users/<?php 
